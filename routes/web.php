...
Route::prefix('admin')->middleware('auth')->group(function () {
  ...
  Route::get('/view-notifications', [DashboardController::class, 'viewnotify'])->name('dashboard.viewnotify');
  Route::get('/get-election-results', [DashboardController::class, 'getElectionResults']);
  ...
  Route::get('manage-party/addimport', [ManagepartyController::class, 'PartyImport'])->name('manageparty.addImport');
  Route::post('manage-party/importparty', [ManagepartyController::class, 'importParty'])->name('manageparty.importparty');
  ...
  Route::get('/manage-polling-unit/getlist', [ManagepollingunitController::class, 'GetPollingUnitlist'])->name('managepollings.getlist');
  ...
  Route::post('manage-users/status/{id}/{status}', [ManageuserController::class, 'status'])->name('manageusers.status');
  ...
  Route::get('manage-election-result/create', [ManageelectionresultController::class, 'add'])->name('manageelectionresult.create');
  ...
  //Manage Donations
  Route::get('manage/donations', [DonationController::class, 'donationlist'])->name('donationlist');
