                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           <select name="category" id="category" class="form-control" required>
                              ...
                              <option value="{{$blogcategory->cat_id}}" {{ $editblogcat && $blogcategory->cat_id == $editblogcat->cat_id ? 'selected' : '' }}>
                                 {{$blogcategory->cat_title}}
                              </option>
                              @endforeach
                           </select>
                        </div>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           <select name="tag" id="tag" class="form-control">
                              ...
                              <option value="{{ $blogtag->tag_id }}" {{ $editblogtag && $blogtag->tag_id == $editblogtag->tag_id ? 'selected' : '' }}>
                                 {{ $blogtag->tag_title }}
                              </option>
                              @endforeach
                           </select>
