               ...
               <div class="col-lg-8">
                     <div class="card">
                        ...
                        <div class="card-block">
                           <form method="post" action="{{route('manageblog.update',$editblogs->id)}}" enctype="multipart/form-data">
                              @csrf
                             <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                   <select name="category" id="category" class="form-control" required>
                                    ...
                                    <option value="{{$blogcategory->cat_id}}" {{$blogcategory->cat_id==$editblogcat->cat_id?'selected':''}}>{{$blogcategory->cat_title}}</option>
                                    @endforeach
                                   </select>
                                 </div>
                              </div>
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                   <select name="tag" id="tag" class="form-control">
                                    ...
                                    <option value="{{$blogtag->tag_id}}" {{$blogtag->tag_id==$editblogtag->tag_id?'selected':''}}>{{$blogtag->tag_title}}</option>
                                    @endforeach
                                   </select>
                                 </div>
                              </div>
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                    <input class="form-control" type="text" name="title" id="title" value="{{$editblogs->page_name}}" required>
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="example-search-input" class="col-xs-2 col-form-label form-control-label">Slug Name *</label>
                                 <div class="col-sm-10">
                                    <input class="form-control" type="text" name="slug" id="slug" value="{{$editblogs->slug}}" readonly>
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="example-url-input" class="col-xs-2 col-form-label form-control-label">Description</label>
                                 <div class="col-sm-10">
                                 <textarea class="form-control" name="description" id="description">{{$editblogs->description}}</textarea>
                                 </div>
                              </div>
                              <div class="form-group row">
                                 ...
                                 <img id="imagePreview" class="img-fluid mt-2" style="height: 138px;width: 256px;" src="{{ asset('images/blogs/' . $editblogs->blog_image) }}"  alt="Preview">
                              </div>
                              <div class="form-group row">
                                 <label for="example-number-input" class="col-xs-2 col-form-label form-control-label">Meta Title</label>
                                 <div class="col-sm-10">
                                    <input class="form-control" name="metatitle" type="text" value="{{$editblogs->meta_title}}" id="metatitle">
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="example-number-input" class="col-xs-2 col-form-label form-control-label">Meta Key</label>
                                 <div class="col-sm-10">
                                    <textarea class="form-control" name="meta_key" id="meta_key">{{$editblogs->meta_key}}
                                    </textarea>
                                 </div>
                              </div>
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                    <textarea class="form-control" name="meta_description" id="meta_description">{{$editblogs->meta_desc}}
                                    </textarea>
                                 </div>
                              </div>
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                    <select class="form-control" name="status" id="status">
                                        <option value="1" {{$editblogs->is_active=='1'?'selected':''}}>Publish</option>
                                        <option value="0" {{$editblogs->is_active=='0'?'selected':''}}>UnPublish</option>
                                    </select>
                                 </div>
                              </div>
                              <div class="form-group row">
