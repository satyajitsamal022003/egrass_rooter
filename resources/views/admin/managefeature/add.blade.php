            ...
            <div class="col-sm-12 p-0">
               <div class="main-header">
                  ...
                  <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                     ...
                     <li class="breadcrumb-item"><a>Add Feature</a>
                     </li>
                  </ol>
               </div>
            </div>
         ...
         <div class="col-lg-8">
            <div class="card">
               <div class="card-header">
                  <h5 class="card-header-text">Add Feature</h5>
               </div>
               <div class="card-block">
                  <form method="post" action="{{route('managefeature.store')}}" enctype="multipart/form-data">
                     @csrf
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           <input class="form-control" type="text" name="feature_class" id="feature_class">
                        </div>
                     </div>
                     <div class="form-group row">
