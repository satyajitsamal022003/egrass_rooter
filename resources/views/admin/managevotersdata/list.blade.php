                    ...
                    <div class="card" style="padding: 20px;">
                        <form id="filterForm" class="form-horizontal">
                                ...
                                <select id="searchemp" name="searchemp" class="form-control">
                                    ...
                                    @if (!empty($getAllemp) && count($getAllemp) > 0)
                                        @foreach ($getAllemp as $getemp)
                                            <option value="{{ $getemp->employ_status }}"
                                                {{ request('searchemp') == $getemp->employ_status ? 'selected' : '' }}>
                                                {{ stripslashes($getemp->employ_status) }}</option>
                                        @endforeach
                                    @else
                            ...
                            <div class="pull-right col-md-12">
                                <div class="col-md-1">
                                    <input type="submit" name="search" id="search" class="btn btn-primary waves-effect"
                                        style="margin-top: 5px;" value="Filter">
                                </div>
                                <div class="col-md-1">
                                    <button type="button" class="btn btn-primary waves-effect"
                                        style="background: #d9534f;margin-top: 5px;" onclick="resetPage()">Reset</button>
                                </div>
                            </div>
                        </form>
