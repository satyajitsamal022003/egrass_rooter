...
<head>
    ...
    <title>Voters Data Imports</title>
</head>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-header-text">Voters Data Import</h5>
                    </div>
                    <div class="card-block">
                        <form method="post" action="{{ route('managevotersdata.import') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <a href="{{asset('/votescsvfile/egrassrooter_contactsimport.csv')}}" download="">CSV Format?</a>
