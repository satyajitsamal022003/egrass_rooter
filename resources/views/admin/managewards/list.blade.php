        ...
        <div class="col-sm-12 p-0">
            <div class="main-header">
                ...
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    ...
                    <li class="breadcrumb-item"><a href="#">Manage Wards</a>
                    </li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card" style="padding: 20px;">
                    <!-- <form action="{{ route('manageward.list') }}" id="filter-form" method="get" class="form-horizontal">
                        <div class="col-sm-3">
                    ...
                    <!-- /.card-header -->
                    <a href="{{route('manageward.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> </a>
                    <div class="card-body">
