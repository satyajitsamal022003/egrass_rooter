                            ...
                            <form method="post" action="{{ route('manageelection.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label for="polling_units" class="col-xs-2 col-form-label form-control-label">Polling
                                        Units</label>
                                    <div class="col-sm-10">
                                        <select class="form-control col-md-7 col-xs-12 js-example-basic-single"
                                            id="polling_units" name="polling_units">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input"
                                        class="col-xs-2 col-form-label form-control-label">Election Year *</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-xs-2 col-form-label form-control-label">Votes
                                        *</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="votes" id="votes"
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-xs-2 col-form-label form-control-label">Pollitical Party
                                        *</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="political_party" id="political_party"
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
