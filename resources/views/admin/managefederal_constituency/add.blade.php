                            ...
                            <form action="{{ route('federalconst.store') }}" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input"
                                        class="col-xs-4 col-form-label form-control-label">Federal Constituency
                                        Name*</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="constituency" id="constituency"
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input"
                                        class="col-xs-4 col-form-label form-control-label">Composition*</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="composition" id="composition"
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input"
                                        class="col-xs-4 col-form-label form-control-label">Collation Center*</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="collation_centre"
                                            id="collation_centre" required>
                                    </div>
                                </div>
                                <div class="form-group row">
