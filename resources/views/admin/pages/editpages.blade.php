                  ...
                  <form method="post" action="{{route('pages.update',$editpages->id)}}" enctype="multipart/form-data">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           ...
                           <img id="imagePreview" class="img-fluid mt-2" style="height: 138px;width: 256px;" src="{{ $editpages->image ? asset('images/pages/' . $editpages->image) : asset('images/blank.jpg') }}" alt="Preview">
                        </div>
                     </div>
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           ...
                           <img id="bannerImagePreview" class="img-fluid mt-2" style="height: 138px;width: 256px;" src="{{ $editpages->banner_image ? asset('images/pages/' . $editpages->banner_image) : asset('images/blank.jpg') }}" alt="Preview">
                        </div>
                     </div>
                     <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           <textarea class="form-control" name="meta_key" id="meta_key">{{$editpages->meta_key }}</textarea>
                        </div>
                     </div>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           <textarea class="form-control" name="meta_description" id="meta_description">{{$editpages->meta_desc }}</textarea>
                        </div>
                     </div>
                     <div class="form-group row">
