  ...
  <section class="content">
    <div class="row">
      <div class="col-12">
        ...
        <a href="{{route('manageclient.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> </a>
          <div class="card-body">
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="status">
                    <label class="switch">
                      <input type="checkbox" onclick="catstatus({{$client->id}})" <?php if ($client->is_active == '1') {
                                                                                    echo "checked";
                                                                                  } ?>>
