            ...
            <div class="col-sm-12 p-0">
               <div class="main-header">
                  ...
                  <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                     ...
                     <li class="breadcrumb-item"><a>Add Client</a>
                     </li>
                  </ol>
               </div>
            </div>
         ...
         <div class="col-lg-8">
            <div class="card">
               <div class="card-header">
                  <h5 class="card-header-text">Add Client</h5>
               </div>
               <div class="card-block">
                  <form method="post" action="{{route('manageclient.store')}}" enctype="multipart/form-data">
                     @csrf
