...
<head>
    ...
    <title>Edit Upcoming Election</title>
                ...
                <div class="col-sm-12 p-0">
                    <div class="main-header">
                        ...
                        <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                            ...
                            <li class="breadcrumb-item"><a>Edit Upcoming Election</a></li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-header-text">Edit Upcoming Election</h5>
                    </div>
                    <div class="card-block">
                        <form method="post" action="{{route('updateupcomingelection', $election->id)}}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="election_type" id="election_type" class="form-control" required onchange="toggleStateField()">
                                        ...
                                        @foreach (App\Models\Electionresulttype::get(['id', 'type']) as $electionType)
                                        <option value="{{ $electionType->id }}" {{ $election->election_type_id == $electionType->id ? 'selected' : '' }}>
                                            {{ $electionType->type }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row" id="stateField">
                                ...
                                <div class="col-sm-10">
                                    <select name="state_id" id="state_id" class="form-control" required>
                                        ...
                                        <option value="{{ $state->id }}" {{ $election->state_id == $state->id ? 'selected' : '' }}>
                                            {{ $state->state }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="election_date" id="election_date" value="{{ old('election_date', $election->election_date) }}" required>
                                </div>
                            </div>
