...
<head>
   ...
   <title>Add State Districts</title>
</head>
            ...
            <div class="col-sm-12 p-0">
               <div class="main-header">
                  ...
                  <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                     ...
                     <li class="breadcrumb-item"><a href="{{route('stateconst.list')}}">Manage State Constituency</a>
                     </li>
                     <li class="breadcrumb-item"><a>Add State Constituency</a>
                     </li>
                  </ol>
               </div>
            </div>
         ...
         <div class="col-lg-8">
            <div class="card">
               <div class="card-header">
                  <h5 class="card-header-text">Add State Districts</h5>
               </div>
               <div class="card-block">
                  <form method="post" action="{{route('stateconst.store')}}">
                     @csrf
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           <input class="form-control" type="text" name="state_const" id="state_const" required>
                        </div>
                     </div>
                     <div class="form-group row">
